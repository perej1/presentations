...
\begin{frame}{Approaches from the Literature (for the Heavy Tail)}
  ...
  \begin{itemize}
    ...
    \item ``Quantiles of $|\hat Y_i - Y_i|$ grow sufficiently slowly''
    \end{itemize}
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{frame}{Common message in the heavy-tailed case}
...
\begin{frame}
  Link to slides: \url{https://github.com/perej1/presentations/blob/main/light-error.pdf}
\end{frame}
